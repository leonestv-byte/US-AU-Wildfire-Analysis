...
fire_data <- us_data[, c("latitude", "longitude", "brightness", "daynight", "acq_date", "acq_time", "daynight", "type")]
...
fire_data_crs_4326$computed_daynight_sza <- ifelse(
  fire_data_crs_4326$sza < 85, "N", "D"
)
...
write.csv(
  fire_data,
  "MSISS/wildfires/main/data/us/us_fires_full_dataset.csv",
  row.names = FALSE
)
